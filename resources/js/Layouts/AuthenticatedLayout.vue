...
<template>
    <div>
        <div class="min-h-screen bg-neutral-content">
            <nav class="bg-neutral border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink v-if="$page.props.auth.user.role == 'teacher'" :href="route('my-section')" :active="route().current('my-section')">
                                    My Students
                                </NavLink>
                            </div>
                        </div>
            ...
            <!-- Page Heading -->
            <header class="bg-neutral shadow" v-if="$slots.header">
